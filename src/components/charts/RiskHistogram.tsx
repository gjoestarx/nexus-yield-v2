...
export function RiskHistogram({ risks }: RiskHistogramProps) {
 ...
 <div className="h-[300px]">
  ...
  <Tooltip content={({ payload }) => {
   ...
   return (<div className="surface rounded-[var(--radius-md)] px-4 py-3 shadow-xl"><div className="text-sm font-medium">Risk: {d.range}</div><div className="text-sm text-[var(--text-3)]">{d.count} pools</div></div>);
  }} />
